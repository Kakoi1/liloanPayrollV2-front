      ...
      <div v-if="user.position !== 'Viewer'" class="relative">
        ...
        >
          <div v-if="!isCollapsed && openMenu === 'voucher'" class="pl-10 mt-1 space-y-1 overflow-hidden">
            ...
            <RouterLink to="/cash-advance" class="block py-2 px-2 text-sm rounded hover:bg-gray-800 hover:text-green-400 transition-colors">
              <span class="flex items-center space-x-2">
                <span class="w-1 h-1 bg-green-400 rounded-full"></span>
      ...
      <div  class="relative">
        ...
        >
          <div v-if="!isCollapsed && openMenu === 'system'" class="pl-10 mt-1 space-y-1 overflow-hidden">
            ...
            <RouterLink to="/holidays" class="block py-2 px-2 text-sm rounded hover:bg-gray-800 hover:text-green-400 transition-colors">
              <span class="flex items-center space-x-2">
                <span class="w-1 h-1 bg-green-400 rounded-full"></span>
                <span>Holidays</span>
              </span>
